...
I implemented patches in v463 to skip the function block which references `"Attachments must be parented to a PartInstance."`.
...
Tracing up to the function above, patch the call out in x86:
