...
```patch
 014EDC4A | 80BF AB000000 00         | cmp byte ptr ds:[edi+AB],0
-014EDC51 | 74 29                    | je robloxplayerbeta.14EDC7C
+014EDC51 | EB 29                    | jmp robloxplayerbeta.14EDC7C
 014EDC53 | 6A 01                    | push 1
 014EDC55 | 68 60CC4E01              | push robloxplayerbeta.14ECC60
 014EDC5A | 68 C34E0000              | push 4EC3
 014EDC5F | FFB7 48010000            | push dword ptr ds:[edi+148]
 014EDC65 | E8 062B0500              | call robloxplayerbeta.1540770
```
...
```
curl_easy_setopt {arg(1)} {arg(2)} [{utf8(arg(2))}]
```
...
```
curl_easy_setopt 2774 23C1DE0 [\x06]
curl_easy_setopt 20 1 []
curl_easy_setopt 9C 927C0 []
curl_easy_setopt 9B 1D4C0 [????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????]
curl_easy_setopt 4EC3 15047C0 [U\x8B\xEC\x83\xEC\x18SV\x8Bu\x102\xC92\xFF\x88M\xFFW\x8B\x06\x83\xF8\x02uS\xFFv\x14\x8DF\x10\xC6E\xFF\x01\x89E\xE8\xFF\x15h\x06\x8E\x01\x8B5\x84n\xFB\x01\x8B=\x88n\xFB\x01;\xF7t\x17\x0F\x1F]
curl_easy_setopt 4EF0 1503620 [U\x8B\xECd\xA1]
curl_easy_setopt 2776 18E9CB8 []
curl_easy_setopt 272D C7D42E8 [\xC89\xAC\x01]
curl_easy_setopt 4E6F 15073D0 [U\x8B\xEC\x8BE\f\x0F\xAFE\x10\x8BM\x14P\xFFu\x08\xE8\x9A\xFC\xFF\xFF]\xC3\xCC\xCC\xCC\xCC\xCC\xCC\xCC\xCCU\x8B\xECV\xFFu\f\x8B\xF1\xFFu\x08\xC7\x06]
curl_easy_setopt 2711 C7D42E8 [\xC89\xAC\x01]
curl_easy_setopt 4E2B 1507060 [U\x8B\xEC\x8BE\f\x0F\xAFE\x10\x8BM\x14P\xFFu\x08\xE8\xFA\xFE\xFF\xFF]\xC3\xCC\xCC\xCC\xCC\xCC\xCC\xCC\xCCU\x8B\xECj\xFFhȟ\x89\x01d\xA1]
curl_easy_setopt 3A 1 []
curl_easy_setopt D5 1 []
curl_easy_setopt D6 3C []
curl_easy_setopt D7 3C []
curl_easy_setopt 40 0 []
curl_easy_setopt 2751 4874420 [C:\\Users\\USER\\Projects\\FilteringDisabled\\Roblox\\v463\\Server\\cacert.pem]
curl_easy_setopt 63 1 []
curl_easy_setopt 60 1 []
curl_easy_setopt 2727 CA657F8 [ئg\f0Y\xA6\f_]
curl_easy_setopt 50 1 []
curl_easy_setopt 2C 0 []
curl_easy_setopt 2734 C7D4338 [GET]
curl_easy_setopt 34 0 []
curl_easy_setopt 2712 C890E38 [https://localhost:2005/test_http]
curl_easy_setopt 2777 C7D42E8 [\xC89\xAC\x01]
```
...
curl_easy_setopt 9C 927C0 []
curl_easy_setopt 9B 1D4C0 [????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????]
curl_easy_setopt 4EC3 1504A20 [U\x8B\xECj\xFFh\x18\x9F\x89\x01d\xA1]
curl_easy_setopt 4EF0 1503620 [U\x8B\xECd\xA1]
curl_easy_setopt 2776 18E9CB8 []
curl_easy_setopt 272D C7D2B00 [\xC89\xAC\x01]
curl_easy_setopt 4E6F 15073D0 [U\x8B\xEC\x8BE\f\x0F\xAFE\x10\x8BM\x14P\xFFu\x08\xE8\x9A\xFC\xFF\xFF]\xC3\xCC\xCC\xCC\xCC\xCC\xCC\xCC\xCCU\x8B\xECV\xFFu\f\x8B\xF1\xFFu\x08\xC7\x06]
curl_easy_setopt 2711 C7D2B00 [\xC89\xAC\x01]
curl_easy_setopt 4E2B 1507060 [U\x8B\xEC\x8BE\f\x0F\xAFE\x10\x8BM\x14P\xFFu\x08\xE8\xFA\xFE\xFF\xFF]\xC3\xCC\xCC\xCC\xCC\xCC\xCC\xCC\xCCU\x8B\xECj\xFFhȟ\x89\x01d\xA1]
curl_easy_setopt 3A 1 []
curl_easy_setopt D5 1 []
curl_easy_setopt D6 3C []
...
curl_easy_setopt 63 1 []
curl_easy_setopt 60 1 []
curl_easy_setopt 2727 CA651F8 [\x08\xA9g\f\x10R\xA6\f_U]
curl_easy_setopt 50 1 []
curl_easy_setopt 2C 0 []
curl_easy_setopt 2734 C7D2B50 [GET]
curl_easy_setopt 34 0 []
curl_easy_setopt 2712 C890888 [https://localhost:2005/test_http]
curl_easy_setopt 2777 C7D2B00 [\xC89\xAC\x01]
```
...
For HTTP requests to send, all we have to do is bypass the `curl_easy_setopt` call with `CURLoption::CURLOPT_OPENSOCKETFUNCTION`. In v463, this becomes is as simple as changing `je` to `jmp`.
...
There is a function which determines whether your URL points to an external website: `RBX::Http::isExternalUrl`. An IDA decompilation from v548 is shown below:
...
When you call `HttpService::RequestInternal` using an 'untrusted' host, we throw the following error `HttpRequest.Url is not trusted`.
